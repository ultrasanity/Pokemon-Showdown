...
const dataImports = require('./dataImports');
...
const MODS = ['gen1', 'gen2', 'gen3', 'gen4', 'gen5', 'gen6',
              'gennext', 'letsgo', 'mixandmega', 'pic', 'pokebilities',
              'ssb', 'stadium', 'vgc17'];
...
class ModdedDex {
    ...
    const TeamGenerator = require('../data/random-teams.js')
	...
	loadDataFile(basePath, dataType) {
      ...
      var tempData = DATA_FILES[dataType];

      if (tempData === 'formats-data'){
        tempData = 'formatsdata';
      }
      const dataObject = dataImports.default[tempData];
